...
\hypersetup{%
  pdftitle={Cosmology from Kaluza--Klein reduction of five-dimensional Lovelock--Cartan theory},
...
On the other hand, the renaissance of the Riemann--Cartan geometries came through the advent of the pioneer works of Sciama~\cite{Sciama:1962} and Kibble~\cite{Kibble:1961ba} on Poincar\'e gauge theories (see also Refs.~\cite{Hehl:1976kj,Blagojevic:2002du}). In such a framework, the torsion appears as the field strength of translations. %In such a framework, the vielbein is interpreted as the gauge connection of translations and the torsion as its field strength. The formulation of gravity as a gauge theory has major benefits in the problem of a unified picture of interactions, since it allows to interpret it as arising through a localization procedure, where the spacetime is a Riemann--Cartan manifold. 
